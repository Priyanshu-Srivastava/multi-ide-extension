  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    label        { display: block; font-size: 11px; text-transform: uppercase;
                   letter-spacing: .6px; opacity: .65; margin-bottom: 5px; }
    ...
    .result-label { font-size: 11px; text-transform: uppercase; letter-spacing: .6px;
    ...
    .history h3 { font-size: 11px; text-transform: uppercase; letter-spacing: .6px;
...
<div class="card">
  ...
  <div class="field">
    ...
    <input id="numA" type="number" value="0" />
  </div>
  <div class="field">
